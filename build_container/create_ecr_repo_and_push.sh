...
docker build --platform linux/amd64 -t $ECR_URI/callisto-jupyter-base-notebook --provenance=false .
...
docker build --platform linux/amd64 -t $ECR_URI/callisto-ddb-jupyter-api --provenance=false .
